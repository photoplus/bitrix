...
$APPLICATION->SetTitle("Портативная техника");
?>
...
$f_mini=file_get_contents("http://www.fotoplus.su/catalog/portable_texnic/mini_filter.txt");
$f_mini = explode(",", $f_mini);

$f_max=file_get_contents("http://www.fotoplus.su/catalog/portable_texnic/filter.txt");
$f_max = explode(",", $f_max);
?>
...
<?$APPLICATION->IncludeComponent("bitrix:catalog", ".default", array(
	...
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/catalog/portable_texnic/",
	"AJAX_MODE" => "N",
