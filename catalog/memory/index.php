...
$f_mini=file_get_contents("http://www.fotoplus.su/catalog/memory/mini_filter.txt");
$f_mini = explode(",", $f_mini);

$f_max=file_get_contents("http://www.fotoplus.su/catalog/memory/filter.txt");
$f_max = explode(",", $f_max);
?>
