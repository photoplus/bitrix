...
$APPLICATION->SetTitle("Студийное оборудование");
?>
 <? $c_el=20; 
if (isset($_POST['c_el'])) 
{$c_el=$_POST['c_el'];
...
$f_mini=file_get_contents("http://www.fotoplus.su/catalog/studio_stuff/mini_filter.txt");
$f_mini = explode(",", $f_mini);

$f_max=file_get_contents("http://www.fotoplus.su/catalog/studio_stuff/filter.txt");
$f_max = explode(",", $f_max);
...
<?$APPLICATION->IncludeComponent("bitrix:catalog", ".default", array(
	...
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/catalog/studio_stuff/",
	"AJAX_MODE" => "N",
...
"LIST_PROPERTY_CODE" => array(0=>$sell_code),
